...
class insar_processing_snap():
    ...
    Orbit_degree_apply_orbit, orbit_degree_ifg, orbit_degree_tpr = 4, 4, 7  # 1, 2, 3, 4 or 5 apply or ifg
    # 1-10 for tpr
    ...
    #                                  'BISINC_11_POINT_INTERPOLATION', 'BISINC_21_POINT_INTERPOLATION', 'BICUBIC_INTERPOLATION'
    #                                  ------------------------------------------------------------------------------------------------------------------------
    DEM_resample_method = 'BILINEAR_INTERPOLATION'
    Image_Resample_Method = 'BILINEAR_INTERPOLATION'
