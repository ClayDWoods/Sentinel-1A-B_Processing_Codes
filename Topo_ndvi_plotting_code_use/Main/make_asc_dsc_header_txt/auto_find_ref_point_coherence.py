...
def auto_find_reference_point(coherence_average_array,
                              half_size,
                              num_of_ref,
                              coh_min,
                              num_of_ref_coh_blocks,
                              num_of_max_to_check):
    try:
        coh_array = coherence_average_array
        block_half_size = half_size
        array_width = coherence_average_array.shape[1]
        array_height = coherence_average_array.shape[0]
